...
int main(int argc, char *argv[]) {
	...
	pthread_create(&carpincho1, NULL, carpincho1_func, "/home/utnso/tp-2021-2c-cuatri-ganado/testing_matelib/test.config");
	pthread_create(&carpincho2, NULL, carpincho2_func, "/home/utnso/tp-2021-2c-cuatri-ganado/testing_matelib/test.config");
	pthread_create(&carpincho3, NULL, carpincho3_func, "/home/utnso/tp-2021-2c-cuatri-ganado/testing_matelib/test.config");
...
/*
int main(void){
	printf("Iniciando testing matelib ====== \n");
	...
	puts("1");
	char* config = "/home/utnso/tp-2021-2c-cuatri-ganado/testing_matelib/test.config";
	mate_init(&inst, config);

	printf("RESPUESTAMEMALLOC %d \n", mate_memalloc(&inst,7));

	printf("RESPUESTAMEMFREE %d \n", mate_memfree(&inst,9));

	//printf("RESPUESTAMEMWRITE %d \n", mate_memwrite(&inst, "Hola", 9, 5));

	//printf("RESPUESTAMEMREAD %d \n", mate_memread(&inst, 9, "Hola", 5));

	printf("Fin testing matelib ====== \n");
}
*/
